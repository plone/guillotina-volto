...
directives.fieldset_field.apply(
    IDublinCore, "effective_date", "dates"
)  # pylint: disable=E1101
directives.fieldset_field.apply(
    IDublinCore, "expiration_date", "dates"
)  # pylint: disable=E1101
directives.fieldset_field.apply(
    IDublinCore, "creators", "ownership"
)  # pylint: disable=E1101
directives.fieldset_field.apply(
    IDublinCore, "tags", "categorization"
)  # pylint: disable=E1101
directives.fieldset_field.apply(
    IDublinCore, "publisher", "ownership"
)  # pylint: disable=E1101
directives.fieldset_field.apply(
